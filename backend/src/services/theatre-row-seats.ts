...
function TheaterRowseats(app: Express) {
    // Add new row seats
    app.post('/row_seats', async (req: Request, res: Response) => {
        ...
        try {
            ...
            const newRow = { id: (results as any).insertId, theater_id, trow_number, seats_count };
    ...
    // Get all row seats
    app.get('/row_seats', async (req: Request, res: Response) => {
    ...
    app.get('/row_seats/:id', async (req: Request, res: Response) => {
    ...
    app.put('/row_seats/:id', async (req: Request, res: Response) => {
        const rowSeatId = parseInt(req.params.id, 10);
    ...
    app.delete('/row_seats/:id', async (req: Request, res: Response) => {
        const rowSeatId = parseInt(req.params.id, 10);
