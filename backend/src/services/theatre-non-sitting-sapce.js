...
function NonSeatingRoutes(app) {
    app.post('/non_seating_space', (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            for (let entry of info) {
                ...
                const [result] = yield promisePool.query(query, [theater_id, trow_number, cell_indexes]);
                // Use type assertion to access insertId
                results.push({ id: result.insertId, theater_id, trow_number, cell_indexes });
            }
    ...
    app.get('/non_seating_space', (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    app.get('/non_seating_space/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const [results] = yield promisePool.query(query, [spaceId]);
    ...
    app.put('/non_seating_space/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
        const spaceId = parseInt(req.params.id, 10);
    ...
    app.delete('/non_seating_space/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
        const spaceId = parseInt(req.params.id, 10);
        if (isNaN(spaceId)) {
            return res.status(400).json({ message: 'Invalid ID format' });
        }
